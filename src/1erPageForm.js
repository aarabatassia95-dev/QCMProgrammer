    ...
    <form onSubmit={next}>
      ...
      <div className="row">
        ...
        <div className="col-md-6 mb-3">
          ...
          <input id="age"  type="number" className="form-control form-control-lg" value={age} onChange={(e) => setAge(e.target.value)} placeholder="Your age"/>
      ...
      <div className="row">
        <div className="col-md-6 mb-3">
          ...
          <input id="email" type="email" className="form-control form-control-lg" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email"/>
